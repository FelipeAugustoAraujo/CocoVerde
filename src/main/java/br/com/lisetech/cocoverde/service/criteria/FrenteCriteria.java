...
/**
 * Criteria class for the {@link br.com.lisetech.cocoverde.domain.Frente} entity. This class is used
 * in {@link br.com.lisetech.cocoverde.web.rest.FrenteResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /frentes?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class FrenteCriteria implements Serializable, Criteria {
    ...
    public FrenteCriteria() {}

    public FrenteCriteria(FrenteCriteria other) {
    ...
    @Override
    public FrenteCriteria copy() {
        return new FrenteCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final FrenteCriteria that = (FrenteCriteria) o;
        return (
