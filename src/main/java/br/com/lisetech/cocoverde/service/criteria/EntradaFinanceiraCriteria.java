...
/**
 * Criteria class for the {@link br.com.lisetech.cocoverde.domain.EntradaFinanceira} entity. This class is used
 * in {@link br.com.lisetech.cocoverde.web.rest.EntradaFinanceiraResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /entrada-financeiras?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class EntradaFinanceiraCriteria implements Serializable, Criteria {
    ...
    public EntradaFinanceiraCriteria() {}

    public EntradaFinanceiraCriteria(EntradaFinanceiraCriteria other) {
    ...
    @Override
    public EntradaFinanceiraCriteria copy() {
        return new EntradaFinanceiraCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EntradaFinanceiraCriteria that = (EntradaFinanceiraCriteria) o;
        return (
    ...
    public String toString() {
        return "EntradaFinanceiraCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            (data != null ? "data=" + data + ", " : "") +
