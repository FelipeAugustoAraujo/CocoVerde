...
import br.com.lisetech.cocoverde.service.FuncionarioQueryService;
import br.com.lisetech.cocoverde.service.FuncionarioService;
...
/**
 * REST controller for managing {@link br.com.lisetech.cocoverde.domain.Funcionario}.
 */
@RestController
...
public class FuncionarioResource {
    ...
    public ResponseEntity<FuncionarioDTO> updateFuncionario(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, funcionarioDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<FuncionarioDTO> partialUpdateFuncionario(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, funcionarioDTO.getId().toString())
        );
    }
